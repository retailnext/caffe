...
train_data = "/home/bvi/data/VOCdevkit/VOC0712/lmdb/VOC0712_trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "examples/person_tracking/person_tracking_test_lmdb"
...
save_dir = "models/person_tracking/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/person_tracking/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/person_tarcking/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/person_tracking/results/sample/{}_score/Main".format(os.environ['HOME'], job_name)
...
for file in os.listdir(snapshot_dir):
  if file.endswith(".caffemodel"):
    ...
    print("basname is " + basename + " model name " + model_name);
...
name_size_file = "data/person_tracking/test_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = "data/person_tracking/labelmap_voc.prototxt"
