 ...
 protected:
  MultiBoxLossLayerTest()
      : num_(3),
        ...
        blob_bottom_orientation_(new Blob<Dtype>(num_, num_priors_*num_orientation_classes_,1,1)),  // Added by Dong Liu for MTL 
    ...
    blob_bottom_vec_.push_back(blob_bottom_orientation_);
  ...
  virtual ~MultiBoxLossLayerTest() {
    ...
    delete blob_bottom_orientation_; 
  ...
  Blob<Dtype>* const blob_bottom_orientation_;   //added by Dong Liu for MTL
...
TYPED_TEST(MultiBoxLossLayerTest, TestSetUp) {
  ...
  multibox_loss_param->set_num_orientation_classes(3);
...
TYPED_TEST(MultiBoxLossLayerTest, TestLocGradient) {
  ...
  multibox_loss_param->set_num_orientation_classes(this->num_orientation_classes_);
  for (int l = 0; l < 2; ++l) {
